...
func (suite *TestsTestSuite) TestTestRunnerCheck_ID() {
	check := &TestRunnerCheck{}
	suite.Equal("tests", check.ID())
}

// TestTestRunnerCheck_Name tests that TestRunnerCheck returns correct name.
func (suite *TestsTestSuite) TestTestRunnerCheck_Name() {
	check := &TestRunnerCheck{}
	suite.Equal("Unit Tests", check.Name())
}

// TestTestRunnerCheck_Run_AllTestsPass tests that TestRunnerCheck returns Pass when all tests pass.
func (suite *TestsTestSuite) TestTestRunnerCheck_Run_AllTestsPass() {
	suite.createGoMod()
...
`
	...
	suite.Equal("tests", result.ID)
	suite.Equal("Unit Tests", result.Name)
}

// TestTestRunnerCheck_Run_TestsFail tests that TestRunnerCheck returns Fail when tests fail.
func (suite *TestsTestSuite) TestTestRunnerCheck_Run_TestsFail() {
	suite.createGoMod()
...
func (suite *TestsTestSuite) TestTestRunnerCheck_Run_NoTestFiles() {
	suite.createGoMod()
...
// TestTestRunnerCheck_Run_EmptyDirectory tests that TestRunnerCheck handles empty directories.
func (suite *TestsTestSuite) TestTestRunnerCheck_Run_EmptyDirectory() {
	suite.createGoMod()
...
// TestTestRunnerCheck_Run_MultipleTestFiles tests that TestRunnerCheck handles multiple test files.
func (suite *TestsTestSuite) TestTestRunnerCheck_Run_MultipleTestFiles() {
	suite.createGoMod()
...
// TestTestRunnerCheck_Run_NestedPackages tests that TestRunnerCheck checks nested packages.
func (suite *TestsTestSuite) TestTestRunnerCheck_Run_NestedPackages() {
	suite.createGoMod()
...
// TestTestRunnerCheck_Run_StderrOutput tests that TestRunnerCheck captures stderr output.
func (suite *TestsTestSuite) TestTestRunnerCheck_Run_StderrOutput() {
	suite.createGoMod()
...
func (suite *TestsTestSuite) TestTestRunnerCheck_Run_StdoutFallback() {
	suite.createGoMod()
...
func (suite *TestsTestSuite) TestTestRunnerCheck_Run_PartialFailure() {
	suite.createGoMod()
