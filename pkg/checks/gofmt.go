...
// GofmtCheck verifies that all Go code is properly formatted.
type GofmtCheck struct{}

func (c *GofmtCheck) ID() string   { return "gofmt" }
func (c *GofmtCheck) Name() string { return "Code Formatting" }

func (c *GofmtCheck) Run(path string) (checker.Result, error) {
